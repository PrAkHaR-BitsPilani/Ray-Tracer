...
public:
     ...
     virtual bool bounding_box(float t0, float t1, AxisAllignedBoundingBox& output_box) const;
 ...
 bool Translate::bounding_box(float t0, float t1, AxisAllignedBoundingBox& output_box) const {
